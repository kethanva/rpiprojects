...
class DesktopClockApp:
    ...
    def setup_ui(self):
        ...
        tk.Label(clock_frame, text="🕒 CURRENT TIME", font=('Arial', 12, 'bold'), 
                bg='white', fg='#333333').pack(pady=(10, 5))
        
        self.time_label = tk.Label(clock_frame, text="", font=('Digital-7', 28, 'bold'), 
                                  bg='white', fg='#2c3e50')
        ...
        tk.Label(date_frame, text="📅 TODAY'S DATE", font=('Arial', 12, 'bold'), 
                bg='white', fg='#333333').pack(pady=(10, 5))
        
        self.date_label = tk.Label(date_frame, text="", font=('Arial', 16, 'bold'), 
                                  bg='white', fg='#2c3e50')
        ...
        tk.Label(weather_frame, text="🌤️ BANGALORE WEATHER", font=('Arial', 12, 'bold'), 
                bg='white', fg='#333333').pack(pady=(10, 5))
        
        self.temp_label = tk.Label(weather_frame, text="", font=('Arial', 24, 'bold'), 
                                  bg='white', fg='#e74c3c')
        self.temp_label.pack()
        
        self.weather_desc_label = tk.Label(weather_frame, text="", font=('Arial', 12), 
                                          bg='white', fg='#7f8c8d')
        self.weather_desc_label.pack(pady=(0, 10))
        
        self.weather_update_label = tk.Label(weather_frame, text="", font=('Arial', 8), 
                                           bg='white', fg='#95a5a6')
        ...
        tk.Label(calendar_frame, text="📆 CALENDAR", font=('Arial', 12, 'bold'), 
                bg='white', fg='#333333').pack(pady=(10, 5))
    ...
    def create_calendar(self):
        ...
        for i, day in enumerate(days):
            label = tk.Label(self.calendar_frame, text=day, font=('Arial', 10, 'bold'),
                           bg='#34495e', fg='white', width=4, height=1)
